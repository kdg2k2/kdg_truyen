                                        ...
                                        <div class="card">
                                            <div class="card-block">
                                                <div class="card-block">
                                                    ...
                                                    <form action="/admin/tacgia/store" method="post" class="post-form"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control"
                                                                    name="tentacgia" required>
                                                            </div>
                                                            <span class="text-danger">@error('tentacgia')
                                                                {{ $message }}
                                                                @enderror</span>
                                                        </div>
                                                        ...
                                                        <div class="form-group d-flex justify-content-between">
                                                            ...
                                                            <a class="btn btn-info waves-effect waves-light"
                                                                type="submit" href="/admin/tacgia-manager">Danh
                                                                sách</a>
                                                        </div>
                                                    </form>
